...
def booking(request):
	...
	if request.method == 'GET':
		...
		context_dict['collection_street_address_1'] = body.__getitem__('collection_street_address_1')
		...
		context_dict['delivery_street_address_1'] 	= body.__getitem__('delivery_street_address_1')
